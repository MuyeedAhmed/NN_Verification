...
# NewW3 = [[nn.W3[i][j] for j in range(l3_size)] for i in range(len(nn.W3))]
...
#     if row_idx == 4:
#         solver.add(y_predict[row_idx] != y_test[row_idx][0])
#     else:
#         solver.add(y_predict[row_idx] == y_test[row_idx][0])
...
if solver.check() == sat:
    ...
    print("]")
    print("y true:", predictions[15:20].reshape(1,-1)) 
else:
