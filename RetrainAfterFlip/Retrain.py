...
if __name__ == "__main__":
    ...
    for file_name in os.listdir(dataset_dir):
        ...
        with open(accuracy_file, "a") as f:
            f.write(f"{file_name},{len(X)},{X.shape[1]},TrainD,{final_metrics_D['train_accuracy']},{final_metrics_D['val_accuracy']},{final_metrics_D['train_loss']},{final_metrics_D['val_loss']}\n")
