...
def GurobiBorder():
    ...
    W1 = torch.load("checkpoints/KMNIST/fc_hidden_weight.pt").numpy()
    b1 = torch.load("checkpoints/KMNIST/fc_hidden_bias.pt").numpy()
    W2 = torch.load("checkpoints/KMNIST/classifier_weight.pt").numpy()
    b2 = torch.load("checkpoints/KMNIST/classifier_bias.pt").numpy()
