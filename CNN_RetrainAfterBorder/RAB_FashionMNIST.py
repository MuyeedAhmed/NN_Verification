...
log_file = "Status_FashionMNIST.txt"
initial_epoch = 400
resume_epoch = 200
timeLimit = 600
...
def GurobiBorder():
    ...
    W1 = torch.load("checkpoints/FashionMNIST/fc_hidden_weight.pt").numpy()
    b1 = torch.load("checkpoints/FashionMNIST/fc_hidden_bias.pt").numpy()
    W2 = torch.load("checkpoints/FashionMNIST/classifier_weight.pt").numpy()
    b2 = torch.load("checkpoints/FashionMNIST/classifier_bias.pt").numpy()
