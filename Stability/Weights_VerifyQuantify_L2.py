...
class NeuralNetwork:
    def __init__(self, W1, W2, W3, b1, b2, b3, activation='relu'):
        self.W1 = W1
        self.W2 = W2
        self.W3 = W3
        self.b1 = b1
...
class VerifyWeights:
    def __init__(self, n, l1, l2, flp_idx, tol, W1, W2, W3, b1, b2, b3, 
    ...
    def RunForward(self, X, activation='relu'):
        nn_before = NeuralNetwork(self.W1, self.W2, self.W3, self.b1, self.b2, self.b3, activation)
        self.labels_before = nn_before.predict(X).reshape(1, -1)[0]
        
        nn_after = NeuralNetwork(self.W1_with_offset, self.W2_with_offset, self.W3_with_offset, 
                                self.b1_with_offset, self.b2_with_offset, self.b3_with_offset, activation)
        self.labels_after = nn_after.predict(X).reshape(1, -1)[0]
        mismatch = 0
    ...
    def main(self, X, activation, flipCount=1):
        # self.LoadDataset()
        mismatch = self.RunForward(X, activation)
